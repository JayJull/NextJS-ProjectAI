        ...
        <div className="flex-1 w-full">
          <Link href={`/pages/Deskripsi/${shortLink}`}>
            <div className="flex items-center justify-center sm:justify-start gap-2">
              <h3 className="font-medium text-gray-900 hover:text-blue-600 hover:underline text-center sm:text-left">{name}</h3>
            </div>
          </Link>
          ...
          <p className="mt-2 text-sm text-gray-600 text-center sm:text-left">{shortDesc}</p>
